...
public class TransFormation {
    ...
    public void mapPartitionsWithIndex() {
        ...
        JavaRDD<Integer> parallelize = jsc.parallelize(list, 4);
    ...
    public void groupByKey() {
        ...
        JavaPairRDD<String, Iterable<String>> stringIterableJavaPairRDD =
                stringStringJavaPairRDD.groupByKey();
    ...
    public void aggregateByKey() {
        ...
        parallelize.flatMap(e -> Arrays.asList(e.split(" ")).iterator())
     ...
     */
    //org.apache.spark.SparkException: Job aborted due to stage failure: Task not serializable: java.io
    ...
    public void countByKey() {
        Map<String, Long> stringLongMap = jsc.textFile("file:\\D:\\sparkData\\data2.txt", 2)
