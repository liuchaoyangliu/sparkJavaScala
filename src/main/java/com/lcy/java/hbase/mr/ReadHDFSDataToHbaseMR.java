...
public class ReadHDFSDataToHbaseMR extends Configured implements Tool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int run = ToolRunner.run(conf, new ReadHDFSDataToHbaseMR(), args);
        System.exit(run);
    }
    ...
    class HDFSToHbaseMapper extends Mapper<LongWritable, Text, Text, NullWritable> {
     ...
     * 95015,王君,男,18,MA
     */
    class HDFSToHbaseReducer extends TableReducer<Text, NullWritable, NullWritable> {
